...
def test_addressed_by_reply_and_mention():
    assert is_addressed("anything", True, "ajbot")
    assert is_addressed("oi @AJBot settle this", False, "ajbot")
    assert not is_addressed("just chatting about bots", False, "ajbot")
    assert not is_addressed("", False, "ajbot")
